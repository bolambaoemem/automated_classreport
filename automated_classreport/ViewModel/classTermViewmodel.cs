...
namespace automated_classreport.ViewModel
{
    class classTermViewmodel
    {
        ...
        public decimal stud_Id { get; set; }
        ...
        public decimal term_total_wgt { get; set; }
        public decimal term_Score { get; set; }
